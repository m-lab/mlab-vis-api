...
location_info_data_fields = api.model('Location Info Data', {
    ...
    'last_month_download_speed_mbps_min': fields.Float,
    'last_month_download_speed_mbps_max': fields.Float,
    'last_month_download_speed_mbps_stddev': fields.Float,
    'last_month_download_speed_mbps_bins': fields.List(fields.Integer, description="Distribution of download speeds"),
    'last_month_upload_speed_mbps_median': fields.Float,
    'last_month_upload_speed_mbps_avg': fields.Float,
    'last_month_upload_speed_mbps_min': fields.Float,
    'last_month_upload_speed_mbps_max': fields.Float,
    'last_month_upload_speed_mbps_stddev': fields.Float,
